...
const int moveJ = 2;
const int minWidth = 20;  // Add minimum width requirement
const int minHeight = 15; // Add minimum height requirement
...
PlayAgain:
    while (!closeRequested && (Console.WindowWidth < minWidth || Console.WindowHeight < minHeight))
    {
        Console.Clear();
        Console.WriteLine($"Console window too small. Current: {Console.WindowWidth}x{Console.WindowHeight}");
        Console.WriteLine($"Minimum size required: {minWidth}x{minHeight}");
        Console.WriteLine("Resize window and press [enter], or [escape] to exit...");
	...
	while (true)
	{
        if (Console.WindowWidth < minWidth || Console.WindowHeight < minHeight)
        {
            ...
            Console.WriteLine("Resize and press [enter] to continue, or [escape] to exit.");
